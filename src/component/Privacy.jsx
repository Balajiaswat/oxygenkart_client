...
const Privacy = () => {
  return (
    <div className="terms-container">
      ...
      <p>
        Your personal information is stored securely on our cloud-based server,
        and we take precautions to ensure your data remains safe.
      </p>
      ...
      <ul>
        ...
        <li>
          The provided contact information (email and phone number) is accurate
          and active.
        </li>
      </ul>
    </div>
